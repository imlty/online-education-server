...
/**
 * 当前没有专门的图片服务器,使用部署的项目地址
 */
public class UploadPicUtils {

    public static String LOCAL_URL = "http://localhost:8080/upload/";
    public static String REMOTE_URL = "http://1.15.85.200:8080/upload/";
    ...
    public static Map<String, String> upload(MultipartFile multipartFile, HttpServletRequest request) {
        ...
        map.put("filePath", UploadPicUtils.LOCAL_URL + newName);
        //map.put("filePath",UploadPicUtils.LOCAL_URL+newName);
